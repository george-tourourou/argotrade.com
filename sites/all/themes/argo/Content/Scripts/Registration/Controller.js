    ...
    function getMarketingParameters()
    {
        ...
        if(getURLParameter("ad_group") !== null) {
            marketingParameters["adGroup"] = getURLParameter("ad_group");
        }
        ...
        if(getURLParameter("c") !== null) {
            marketingParameters["c"] = getURLParameter("c");
        }
        ...
        if(getURLParameter("af_sub1") !== null) {
            marketingParameters["afSub1"] = getURLParameter("af_sub1");
        }

        if(getURLParameter("af_sub2") !== null) {
            marketingParameters["afSub2"] = getURLParameter("af_sub2");
        }

        if(getURLParameter("af_sub3") !== null) {
            marketingParameters["afSub3"] = getURLParameter("af_sub3");
        }
        ...
        if(getURLParameter("mid") !== null) {
            marketingParameters["mid"] = getURLParameter("mid");
        }

        if(getURLParameter("cid") !== null) {
            marketingParameters["cid"] = getURLParameter("cid");
        }

        if(getURLParameter("zid") !== null) {
            marketingParameters["zid"] = getURLParameter("zid");
        }
    ...
    jQuery("form#registration-form").validate({
        ...
        submitHandler: function(form, e) {
            ...
            const RegistrationRequest = {
                ...
                apiUrl: 'https://services-argotrade.extsrv.com/',
                platformUrl: 'https://live-cosmos.argo.trade',
                isDebug: false,
