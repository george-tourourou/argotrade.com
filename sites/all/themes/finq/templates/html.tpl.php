...
<head>
  <meta charset="utf-8">
    ...
    <?php if(IsAdmin()) { ?>
	<link rel="stylesheet" href="/sites/all/themes/argo/css/Components/Admin.css" />
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> 
	...
	<script src="/sites/all/themes/argo/Content/js/WidgetCommunicator.js"></script>
	<script src="/sites/all/themes/argo/Content/js/Base64.js"></script>
	<script src="/sites/all/themes/argo/Content/js/Tabs.js"></script>
	<script type="text/javascript" src="/sites/all/themes/argo/Content/js/slick/slick.min.js"></script>
  <?php print $head; ?>  
